...
def get_args():
    ...
    parser.add_argument('--model', '-m', default='resnet50',
                        metavar='FILE',
                        help="backcone name")
    parser.add_argument('--weight', '-w', default='./checkpoints/CP_epoch30.h5',
                        metavar='FILE',
    ...
    #"../data/train/imgs/CVC_Original" , "../data/test/imgs/ETIS_imgs_png"
    #"../data/train/masks/CVC_Ground Truth"../data/test/masks/ETIS_Ground Truth_png"
    ...
    parser.add_argument('--output', '-o', metavar='OUTPUT', nargs='+', default="./data/result/",
...
if __name__ == "__main__":
    ...
    for i, fn in enumerate(in_files):
        ...
        mask = np.expand_dims(mask)  # for calculate dice coefficient, shape :  (1, H, W)
        target = np.expand_dims(target)   # for calculate dice coefficient
