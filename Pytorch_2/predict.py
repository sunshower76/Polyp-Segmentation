...
def get_args():
    ...
    parser.add_argument('--model', '-m', default='./checkpoints/CP_epoch80.pth',
                        metavar='FILE',
    ...
    parser.add_argument('--output', '-o', metavar='OUTPUT', nargs='+', default="./data/result/test2",
...
def get_output_filenames(args):
    ...
    in_files.sort()
    out_files = [] # list of paths of predicted_mask to be saved.
...
if __name__ == "__main__":
    ...
    os.environ["CUDA_VISIBL_DEVICES"]="7" 
    """
    args = get_args()
    ...
    net = resUnet50(n_classes=1,bilinear=True, pretrained=False)
    ...
    net.load_state_dict(torch.load(args.model, map_location=device))  # load weights of model.
